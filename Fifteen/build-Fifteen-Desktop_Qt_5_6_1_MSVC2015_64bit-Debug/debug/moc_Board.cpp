...
QT_MOC_LITERAL(1, 6, 8), // "moveMade"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 7), // "gameWon"
QT_MOC_LITERAL(4, 24, 11) // "moveClicked"

    },
    "Board\0moveMade\0\0gameWon\0moveClicked"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::moveMade)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Board::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::gameWon)) {
                *result = 1;
                return;
            }
        }
