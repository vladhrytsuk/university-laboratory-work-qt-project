    ...
    QDialog(parent)
{
    ...
    pb = new QPushButton("addRow for table 1", this);
    QPushButton *pb1 = new QPushButton("addRow for table 2", this);
    submitButton= new QPushButton("Submit",this);
    revert= new QPushButton("Revert",this);
    QPushButton *addF1= new QPushButton("Insert data",this);
    ...
    QPushButton *push=new QPushButton("Selection 1",this);
    QPushButton *push1=new QPushButton("Selection 2",this);
    select->addWidget(push);
    select->addWidget(push1);

    lineedit->addWidget(text);
    text->setText("TABLE_NAME");
    lineedit->addWidget(text1);
    text1->setText("FIELD_1");
    lineedit->addWidget(text2);
    text2->setText("FEILD_2");
    lineedit->addWidget(text3);
    text3->setText("FIELD_3");
    lineedit->addWidget(text4);
    text4->setText("FIELD_4");
...
//выборка по фамилии (и месяцу) вида работы
